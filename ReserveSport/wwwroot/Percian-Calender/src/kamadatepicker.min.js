...
$(function () { var ids = $("[DatePicker]");$(ids).each(function (index, value) { $(value).prop("id", "DatePicker" + index);}); $(ids).each(function (index, value) {  var inputId = $(value).prop('id');  kamaDatepicker(inputId, customOptions);});});
